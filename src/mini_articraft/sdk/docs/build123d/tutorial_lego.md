...
- https://build123d.readthedocs.io/en/latest/_sources/tutorial_lego.rst.txt

Use this page for a step-by-step parametric Lego block tutorial using sketches, offsets, grids, extrusion, pips, and fillets.
...
Code reference: `docs/sdk/build123d/examples/lego.py`.
