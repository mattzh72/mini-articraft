...
- https://build123d.readthedocs.io/en/latest/_sources/location_arithmetic.rst.txt

Use this page for algebra-mode placement semantics for planes, locations, positions, and rotations.
## Location arithmetic for algebra mode
