...
- https://build123d.readthedocs.io/en/latest/_sources/build_part.rst.txt

Use this page for the `BuildPart` context manager for creating three-dimensional parts from objects, sketches, and operations.
...
* For sketches, the planes that they were constructed on is maintained in internal
  data structures such that operations like `extrude` will
...
This tea cup example uses implicit parameters - note the `sweep`
