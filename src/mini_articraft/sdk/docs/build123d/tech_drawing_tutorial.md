...
- https://build123d.readthedocs.io/en/latest/_sources/tech_drawing_tutorial.rst.txt

Use this page for how to create projected 2D technical drawing views from a build123d model and export SVG output.
...
Code reference: `docs/sdk/build123d/snippets/technical_drawing.py`.
