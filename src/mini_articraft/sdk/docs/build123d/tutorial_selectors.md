...
- https://build123d.readthedocs.io/en/latest/_sources/tutorial_selectors.rst.txt

Use this page for a step-by-step selector walkthrough that builds a part and fillets the intended edge using robust topological selection.
...
Code reference: `docs/sdk/build123d/snippets/selector_example.py`.
