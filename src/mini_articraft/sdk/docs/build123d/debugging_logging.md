...
- https://build123d.readthedocs.io/en/latest/_sources/debugging_logging.rst.txt

Use this page for debugging build123d scripts with Python debuggers, logging, and diagnostic output.
