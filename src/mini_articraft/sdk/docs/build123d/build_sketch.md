...
- https://build123d.readthedocs.io/en/latest/_sources/build_sketch.rst.txt

Use this page for the `BuildSketch` context manager for creating planar two-dimensional profiles.
...
Code reference: `docs/sdk/build123d/snippets/objects_2d.py`.
