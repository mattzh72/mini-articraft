...
- https://build123d.readthedocs.io/en/latest/_sources/tutorial_design.rst.txt

Use this page for a step-by-step workflow for analyzing a part, choosing an origin, sketching profiles, extruding, filleting, and adding holes.
