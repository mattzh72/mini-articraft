...
_CRITIQUE_GUIDANCE = (
    ...
    "defects seriously and fix "
    "them, but do not keep re-critiquing to chase minor polish: once it reports no serious "
    "defects, stop and finish. One or two rounds on the parts you are unsure about is "
    "usually enough."
)
